...
struct controller_t
{
    ...
    /* 0x04 */  f32     stick[2];
    /* 0x0C */  f32     stick_mag;
    /* 0x10 */  u16     button_held;
    /* 0x12 */  u16     button_down;
    /* 0x14 */  void   *pad;
    /* 0x18 */  void   *status;
};  /* 0x1C */
...
struct gfx_callback_t
{
    ...
    /* 0x14 */  void  (*callback)(s32, struct gfx_callback_t *, f32[4][4]);
    /* 0x18 */  s32     arg;
};  /* 0x1C */
...
struct gfx_camera_t
{
    /* 0x00 */  struct gfx_callback_t gfx_callback;
    /* 0x1C */  f32     pos[3];
    /* 0x28 */  f32     obj[3];
    /* 0x34 */  f32   (*mtxf)[4][4];
    /* 0x38 */  s16     rot_z_m;
...
struct player_t
{
    ...
    /* 0x08 */  u32     particle;
    /* 0x0C */  u32     action;
    /* 0x10 */  u32     action_prev;
    /* 0x14 */  u32     ground_sfx;
    /* 0x18 */  s16     action_state;
    /* 0x1A */  u16     action_timer;
    /* 0x1C */  u32     action_arg;
    /* 0x20 */  f32     stick_mag;
    /* 0x24 */  s16     stick_rot;
    ...
    /* 0xA4 */  u32     object_touch_flags;
    /* 0xA8 */  s16     coins;
    /* 0xAA */  s16     stars;
    /* 0xAC */  s8      keys;
    /* 0xAD */  s8      lives;
    /* 0xAE */  s16     health;
    /* 0xB0 */  s16     height_motion;
...
/* 0x8032DD50 */ extern u8 g_player_blink_table[];
...
/* 0x8032DF00 */ extern struct gfx_obj_t *g_gfx_object;
...
/* 0x8033B170 */ extern struct player_t g_players[1];
/* 0x8033B3B0 */ extern struct player_gfx_t g_player_gfx_table[2];
/* 0x8033B400 */ extern void *g_segment_table[0x20];
